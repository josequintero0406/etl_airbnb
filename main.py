...
Uso:
    python main.py --limite 1000   # Para prueba rápida con 1000 registros por colección
"""
...
def ejecutar_etl(mongo_uri: str, db_name: str, limite: int = 0) -> None:
    ...
    """
    logger.info("╔══════════════════════════════════════╗")
    logger.info("║   ETL AIRBNB BUENOS AIRES — INICIO   ║")
    logger.info("╚══════════════════════════════════════╝")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ETL Airbnb Buenos Aires")
    parser.add_argument("--uri", default="mongodb://localhost:27017", help="URI de MongoDB")
    parser.add_argument("--db", default="airbnb_argentina", help="Nombre de la base de datos")
